...
Apr_2022_df <- read_csv("Desktop/Project/CSV files 2022-23/202204-divvy-tripdata.csv") 
May_2022_df <- read_csv("Desktop/Project/CSV files 2022-23/202205-divvy-tripdata.csv") 
June2022_df <- read_csv("Desktop/Project/CSV files 2022-23/202206-divvy-tripdata.csv")
July_2022_df <- read_csv("Desktop/Project/CSV files 2022-23/202207-divvy-tripdata.csv") 
Aug_2022_df <- read_csv("Desktop/Project/CSV files 2022-23/202208-divvy-tripdata.csv")
Sept_2022_df <- read_csv("Desktop/Project/CSV files 2022-23/202209-divvy-publictripdata.csv") 
Oct_2022_df <- read_csv("Desktop/Project/CSV files 2022-23/202210-divvy-tripdata.csv") 
Nov_2022_df <- read_csv("Desktop/Project/CSV files 2022-23/202211-divvy-tripdata.csv")
Dec_2022_df <- read_csv("Desktop/Project/CSV files 2022-23/202212-divvy-tripdata.csv")
Jan_2023_df <- read_csv("Desktop/Project/CSV files 2022-23/202301-divvy-tripdata.csv") 
Feb_2023_df <- read_csv("Desktop/Project/CSV files 2022-23/202302-divvy-tripdata.csv") 
Mar_2023_df <- read_csv("Desktop/Project/CSV files 2022-23/202303-divvy-tripdata.csv") 

#merge all of the data frames into one year view
cyclistic_df <- rbind (Apr_2022_df, May_2022_df, June2022_df, July_2022_df, Aug_2022_df, Sept_2022_df,
                       Oct_2022_df, Nov_2022_df, Dec_2022_df,Jan_2023_df, Feb_2023_df, Mar_2023_df)

#remove individual month data frames to clear up space in the environment 
remove(Apr_2022_df, May_2022_df, June2022_df, July_2022_df, Aug_2022_df, Sept_2022_df,
       Oct_2022_df, Nov_2022_df, Dec_2022_df,Jan_2023_df, Feb_2023_df, Mar_2023_df)
